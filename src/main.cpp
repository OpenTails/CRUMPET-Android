...
int serviceMain(int argc, char *argv[])
{
    ...
    QTimer::singleShot(1, &app, [&srcNode, appSettings, btConnectionManager]() {
        ...
        QVector<int> roles;
        roles << BTDeviceModel::Name << BTDeviceModel::DeviceID << BTDeviceModel::DeviceVersion << BTDeviceModel::BatteryLevel << BTDeviceModel::CurrentCall << BTDeviceModel::IsConnected << BTDeviceModel::ActiveCommandTitles << BTDeviceModel::Checked << BTDeviceModel::HasListening << BTDeviceModel::ListeningState << BTDeviceModel::EnabledCommandsFiles << BTDeviceModel::MicsSwapped << BTDeviceModel::SupportsOTA << BTDeviceModel::HasAvailableOTA << BTDeviceModel::HasOTAData << BTDeviceModel::DeviceProgress << BTDeviceModel::ProgressDescription << BTDeviceModel::OperationInProgress << BTDeviceModel::OTAVersion << BTDeviceModel::HasLights << BTDeviceModel::HasShutdown << BTDeviceModel::HasNoPhoneMode << BTDeviceModel::NoPhoneModeGroups << BTDeviceModel::ChargingState;
