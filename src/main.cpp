...
int serviceMain(int argc, char *argv[])
{
    ...
    QTimer::singleShot(1, &app, [&srcNode, appSettings, btConnectionManager]() {
        ...
        QVector<int> roles;
        roles << BTDeviceModel::Name << BTDeviceModel::DeviceID << BTDeviceModel::DeviceVersion << BTDeviceModel::BatteryLevel << BTDeviceModel::CurrentCall << BTDeviceModel::IsConnected << BTDeviceModel::ActiveCommandTitles;
